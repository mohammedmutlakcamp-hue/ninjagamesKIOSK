...
const MENU_ITEMS = [
  ...
  { id: 'chicken_burger', name: 'Chicken Burger', nameAr: 'برجر دجاج', category: 'food', price: 120, priceJOD: 1.20, description: 'Crispy fried chicken burger', available: true, preparationTime: 7, image: '/img/menu/burger.jpg' },
